    ...
    _emitChange() {
        try {
            ...
            function modifyExchangeMaterialsList() {
                ...
                let headers = document.querySelectorAll("div[class='card-header h5']")
                for (const potentialHeader of headers) {

                    if (potentialHeader.textContent != "Materials") {
                        continue
                    }

                    let materialsList = potentialHeader.parentElement.querySelector("div[class='row g-4'] div.card-body")
                    if (!materialsList) {
                        return false
                    }
